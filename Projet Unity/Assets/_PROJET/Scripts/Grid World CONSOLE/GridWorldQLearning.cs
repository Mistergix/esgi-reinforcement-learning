...
{
    [CreateAssetMenu(menuName = Strings.GridWorldConsoleAlgos + "Q Learning")]
    public class GridWorldQLearning : QLearning<GridWorldGame, QAgentGridWorldConsole, QStateGridWorldConsole>, IGridWorldAi
    {
        ...
        protected override QStateGridWorldConsole GoalState => _statesDictionary[Level.end];
