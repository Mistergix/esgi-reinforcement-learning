...
namespace TaskAtlasNamespace
{
    ...
    public class TaskAtlasEditorWindow : EditorWindow
    {
        ...
        [MenuItem("Tools/TaskAtlas/TaskAtlas/Landmark Editor")]
        ...
        [MenuItem("Tools/TaskAtlas/Discord Server")]
        private static void Discord()
        {
            Application.OpenURL("https://discord.gg/W8MKrRH");
        }

        [MenuItem("Tools/TaskAtlas/Email Us")]
        ...
        [MenuItem("Tools/TaskAtlas/TaskAtlas/Rate TaskAtlas")]
        private static void Rate()
        {
            Application.OpenURL("https://assetstore.unity.com/packages/tools/utilities/perfect-f-177783");
        }

        [MenuItem("Tools/TaskAtlas/More ShrinkRay Assets")]
